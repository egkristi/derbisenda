# Derbisenda — Licensing

Derbisenda uses a **dual-license model**: open source for the community,
...
Derbisenda is licensed under the
...
1. Use Derbisenda commercially with **>50 users** and **>$5M revenue/year**
2. Distribute Derbisenda inside a product **without** releasing your source under AGPLv3
3. Offer Derbisenda as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer Derbisenda
...
Open an issue: https://github.com/egkristi/derbisenda/issues
